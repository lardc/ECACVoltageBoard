...
#define REG_RMS_I1_FINE_P0				49	// Коэффициент тонкой подстройки RMS тока диапазона 1 P0
...
#define REG_RMS_I2_FINE_P0				52	// Коэффициент тонкой подстройки RMS тока диапазона 2 P0
